-- ============================================================
-- Database Dump
-- Created at : 2026-03-22T13:02:36.549Z
-- Dialect    : postgres
-- Tables     : SchoolYears, Offices, Schedules, SupervisorUsers, ActivityRecords, Logs, Summaries, Users
-- ============================================================
...
-- Columns: id | first_name | middle_name | last_name | ccc_id | email | password | role | profile_link | course | target_hours | office_id | isAdmin | current_sy | createdAt | updatedAt | custom_id
INSERT INTO "Users" ("id", "first_name", "middle_name", "last_name", "ccc_id", "email", "password", "role", "profile_link", "course", "target_hours", "office_id", "isAdmin", "current_sy", "createdAt", "updatedAt", "custom_id") VALUES
...
-- ============================================================
-- End of Dump — 2026-03-22T13:02:36.549Z
-- ============================================================