...
// Timeout accent: bold orange-red
const _timeoutAccent = Color(0xFFFF4E0B);

class TimeOutSheet extends StatefulWidget {
  final Function(TimeOfDay, String?, dynamic) onSave;
  const TimeOutSheet({super.key, required this.onSave});

  @override
  State<TimeOutSheet> createState() => _TimeOutSheetState();
}

class _TimeOutSheetState extends State<TimeOutSheet> {
            ...
            children: [
              ...
              if (_supportsCamera) ...[
                _dialogSourceTile(
                  ...
                  label: 'Take Photo',
                  sub: _isDesktopOrWeb ? 'Use your device camera' : 'Use your camera',
                  onTap: _onCameraTap,
                ),
        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: _timeoutAccent.withOpacity(isDark ? 0.15 : 0.10),
                borderRadius: BorderRadius.circular(8),
              ),
              child: Icon(icon, color: _timeoutAccent, size: 18),
            ),
              ...
              children: [
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.logout_rounded, color: _timeoutAccent, size: 20),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Complete your attendance record',
                            style: GoogleFonts.dmSans(fontSize: 12, color: ThemeManager.muted(context)),
                          ),
                        ],
                      ),
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      flex: 2,
                      child: _saveButton(context, hasImage, () {
                        widget.onSave(_selectedTime, _proofImageBase64, _proofImageFile);
                        Navigator.pop(context);
                      }),
                    ),
                  ],
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: _timeoutAccent.withOpacity(isDark ? 0.15 : 0.08),
              borderRadius: BorderRadius.circular(7),
            ),
            child: const Icon(Icons.access_time_rounded, size: 16, color: _timeoutAccent),
          ),
          const SizedBox(width: 12),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Container(
            ...
            child: Text(
              'Now',
              style: GoogleFonts.dmSans(fontSize: 11, fontWeight: FontWeight.w600, color: _timeoutAccent),
            ),
          ),
        ],
      ),
  ...
  Widget _proofLabel(BuildContext context, bool hasImage) {
    return Row(
        ...
        if (!hasImage)
          TextButton.icon(
            ...
            style: TextButton.styleFrom(
              foregroundColor: _timeoutAccent,
  ...
  Widget _saveButton(BuildContext context, bool hasImage, VoidCallback onSave) {
    return ElevatedButton.icon(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: _timeoutAccent,
...
class _ImageSourceSheetContent extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          if (showCamera) ...[
            _sourceTile(context, Icons.camera_alt_rounded, 'Take Photo', 'Use your camera', onCamera, isDark),
            const SizedBox(height: 8),
          ],
          _sourceTile(
            context,
  ...
  Widget _sourceTile(BuildContext context, IconData icon, String label, String sub, VoidCallback onTap, bool isDark) {
    return InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(10),
      child: Container(
