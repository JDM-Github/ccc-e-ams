...
class AddScheduleDialog extends StatefulWidget {
  ...
  const AddScheduleDialog({super.key, required this.detailStore, required this.selectedDate, this.onSuccess});
        ...
        child: Column(
          ...
          children: [
            ...
            ConstrainedBox(
              ...
              child: SingleChildScrollView(padding: const EdgeInsets.all(24), child: _formBody(hours)),
            ),
            Divider(height: 1, color: ThemeManager.dividerColor(context)),
            Padding(
  ...
  Widget _formBody(double? hours) {
    return Column(
      ...
      children: [
        ...
        if (!_isInOffice) ...[
          const SizedBox(height: 8),
          _warningBanner('This record is marked as Work From Home', Icons.info_outline_rounded, Colors.blue),
          const SizedBox(height: 8),
          _toggleCard(
