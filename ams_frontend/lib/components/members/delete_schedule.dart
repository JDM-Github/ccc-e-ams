...
class DeleteScheduleDialog extends StatelessWidget {
  ...
  const DeleteScheduleDialog({super.key, required this.onConfirm});
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.delete_forever_rounded, color: ThemeManager.errorTextColor(context), size: 20),
                  ),
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Are you sure you want to permanently delete this schedule record?',
                        style: GoogleFonts.dmSans(
                          fontSize: 13,
